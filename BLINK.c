...

{
...

    {
        ...
        GPIO_PORTF_DATA_R |= LED_ON1; //Turn on RED LED

        Delay(); //Delay almost 1 sec

        GPIO_PORTF_DATA_R &= ~GPIO_PORTF_DATA_R; //Turn off LED

        Delay();

        GPIO_PORTF_DATA_R |= LED_ON2; //Turn on Blue
        ...
        GPIO_PORTF_DATA_R |= LED_ON3; //Turn on Green
